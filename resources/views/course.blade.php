        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                    ...
                    <p class="me-xl-8 mb-5 text-white">Master Figma app to get a job in UI Design, User Interface, User Experience design, Web Design & UX design.</p>
                    ...
                    <div class="d-md-flex align-items-center mb-6">
                        ...
                        <div class="ms-md-6">
                            <div class="mb-2 d-flex align-items-center">
                                <h6 class="mb-0 text-white font-size-sm">Created by</h6>
                                <a href="#" class="font-size-sm text-white ms-3">Alison Dawn</a>
                            </div>

                            <div class="mb-2 d-flex align-items-center">
                                <h6 class="mb-0 text-white font-size-sm">Categories</h6>
                                <a href="#" class="font-size-sm text-white ms-3">Design</a>
                            </div>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center py-4 bg-transparent border-white-10">
                ...
                <div class="col-lg-6">
                    <a href="https://www.youtube.com/watch?v=9I-Y6VQ6tyI" class="d-block sk-thumbnail img-ratio-1 rounded mb-5" data-fancybox>
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <ins class="h2 mb-0 text-white">$89.99</ins>
                    ...
                    <div class="d-md-flex">
                        <button class="btn btn-blue btn-wide mb-4 mb-md-0 me-md-3 flex-grow-1" type="button" name="button">BUY NOW</button>
                        <button class="btn btn-orange btn-wide mb-4 mb-md-0 ms-md-3 flex-grow-1" type="button" name="button">ENROLL</button>
                    </div>
                </div>
            </div>
        </div>
