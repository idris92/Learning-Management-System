            ...
            <div class="col-xl-8" >
                <div class="row row-cols-md-2 mb-3 ">
                    <div class="card" style="background-color:transparent !important; border:1px solid rgba(0,0,0,0.1) !important">
                        <div class="card-body" >
                            <div style="text-align: center;" ><img src="images/brand-dark1.png"></div>
                          <form >
                            <div class="col-lg-12 " style="display: flex;">
                                <div class="form-group mb-4 col-lg-6">
                                    <label for="exampleInputEmail1">Name</label>
                                    <input disabled type="text" class="form-control" id="exampleInputEmail1" placeholder="Name">
                                </div>
                                <div class="form-group mb-4 col-lg-6" style=" margin-left:2px !important">
                                    <label for="exampleInputEmail1">Email address</label>
                                    <input disabled type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Email">
                                </div>
                            </div>
                            <div class="col-lg-12 " style="display: flex;">
                                <div class="form-group mb-4 col-lg-6">
                                    <label for="exampleInputEmail1">Address</label>
                                    <input disabled type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Address">
                                </div>
                                <div class="form-group mb-4 col-lg-6" style=" margin-left:2px !important">
                                    <label for="exampleInputEmail1">Phone Number</label>
                                    <input disabled type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Bio">
                                </div>
                            </div>
                            <div class="col-lg-12 " style="display: flex;">
                                <div class="form-group mb-4 col-lg-12" style=" margin-left:2px !important">
                                    <label for="exampleInputEmail1">Bio</label>
                                    <textarea disabled type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Bio"></textarea>
                                </div>
                            </div>
