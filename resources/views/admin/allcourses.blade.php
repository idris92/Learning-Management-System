    ...
    <div class="card border shadow p-2 lift sk-fade">
        ...
        <div class="card-zoom position-relative">
            ...
            <a href="" class="card-img sk-thumbnail d-block">
                <img class="rounded shadow-light-lg" src="images/{{$item->videoimage}}" alt="profile">
            </a>
        ...
        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
            ...
            <!-- Preheading -->
            <a href=""><span class="mb-1 d-inline-block text-gray-800">{{$item->category}}</span></a>

            <!-- Heading -->
            <div class="position-relative">
                <a href="/admin_allcourses?id={{$item->id}}" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">{{$item->course_title}}l</h4></a>
                ...
                <div class="row mx-n2 align-items-end">
                    ...
                    <div class="col-auto px-2 text-right">
                        ...
                        <ins class="h4 mb-0 d-block mb-lg-n1">${{$item->course_price}}</ins>
                    </div>
                </div>
            </div>
        </div>
